...
def grad_odf(t, beta, alpha = None):
    """
...
def fdof(t, beta, alpha):
    """
    General function of an driven damped oscilation
...
def grad_fdof(t, beta, alpha):
    """
    Gradient function of the general function of an driven damped oscilation
